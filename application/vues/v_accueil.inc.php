    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                ...
                <div>
                    <a href="#tarif" class="btn-get-started scrollto">Démarrer dès maintenant</a>
                </div>
            </div>
            <div class="col-lg-6 order-1 order-lg-2 accueil-img">
                <img src="<?php echo Chemins::IMAGES . 'logo_central.png'; ?>" class="img-fluid animated" alt="">
            </div>
        </div>
    </div>
</section>
<main id="main">
   ...
   <!-- ======= Comparatif Section ======= -->
    <section id="comparatif" class="faq section-bg">
      <div class="container" data-aos="fade-up">
       ...
       <!-- ======= Commentaire Section ======= -->
    <section id="commentaire" class="faq section-bg">
      <div class="container" data-aos="fade-up">

        <div class="section-title">
          <h2>Commentaire</h2>
          <p>Ce que les Clients Pensent de nous</p>
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
                <h4>  test  </h4>
        </div>
    </section>
    <!-- ======= Ils nous font confiance Section ======= -->
    <section id="confiance" class="clients section-bg">
        <div class="container" data-aos="fade-up">
