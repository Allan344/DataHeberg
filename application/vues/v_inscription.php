      ...
      <div class="container-signup">
          <div class="signup-content">
              <div class="signup-form">
                  ...
                  <form action="signup.php" method="POST" class="register-form" id="register-form" onsubmit="return validateForm();">
                      ...
                      <div class="form-group">
                          ...
                          <label for="agree-term" class="label-agree-term"><span><span></span></span>J'accepte toutes les déclarations des <a href="/CGU-CGV/CGU-CGV.html" class="term-service">Conditions d'utilisation</a></label>
                      </div>
                      <div class="form-group">
                      <?php
                      if(isset($_GET['error'])){
              ...
              <div class="signup-image">
                  ...
                  <a href="#" class="signup-image-link">Je suis déjà inscrit</a>
              </div>
          </div>
      </div>
  </section>
